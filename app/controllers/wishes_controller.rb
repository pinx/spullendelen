class WishesController < ApplicationController
  ...
  def create
    ...
    @wish.member_id = current_member.id
  ...
  def update
    respond_to do |format|
      if @wish.can_be_updated_by?(current_member) && @wish.update(wish_params)
  ...
  def destroy
    if @wish.can_be_updated_by?(current_member)
      @wish.destroy
    end
    respond_to do |format|
  ...
  private
    ...
    def wish_params
      params.require(:wish).permit(:member_id, :thing_id, :description, :story)
    end
end
